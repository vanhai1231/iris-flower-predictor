...
import { B as Block, S as Static, j as BlockLabel, Z as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, _ as getWorkerProxyContext } from './2-DzJuCZmo.js';
...
const lang_map = {
  python: () => import('./index33-DaJAsUY1.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index34-zKLIMXBJ.js'),
      import('./frontmatter-8HPcaTJI.js')
    ]);
  ...
  json: () => import('./index38-CxCOd0aQ.js').then((m) => m.json()),
  html: () => import('./index35-B5kOGPiC.js').then((m) => m.html()),
  css: () => import('./index36-BJn_uYVN.js').then((m) => m.css()),
  javascript: () => import('./index37-C1E77KL3.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index37-C1E77KL3.js').then(
...
//# sourceMappingURL=Index16-CPkaanxR.js.map
