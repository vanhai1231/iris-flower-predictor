...
import { B as Block, S as Static, j as BlockLabel, J as File$1, n as Empty, U as UploadText, o as IconButtonWrapper, q as IconButton, Q as Undo, u as Download } from './2-DzJuCZmo.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-BIhA663U.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-1f3R-r6N.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-B2ojh05l.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-CrWIQmIr.js.map
