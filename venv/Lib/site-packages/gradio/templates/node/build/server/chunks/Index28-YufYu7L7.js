import { B as Block, S as Static, o as IconButtonWrapper, F as FullscreenButton, Y as BlockTitle, n as Empty, as as LineChart, am as globals } from './2-DzJuCZmo.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-BSsuBlyM.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index28-YufYu7L7.js.map
